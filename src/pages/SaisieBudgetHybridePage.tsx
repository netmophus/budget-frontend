/**
 * SaisieBudgetHybridePage (Lot saisie hybride).
 *
 * Saisie « focalisée » complémentaire à la grille complète
 * (SaisieBudgetairePage, inchangée) :
...
export function SaisieBudgetHybridePage(): JSX.Element {
